...
**Dado** um rascunho local de atividade e de estado do dia. **Quando** o armazenamento local é inspecionado. **Então** ele não contém nome de trabalhador, e some quando o lançamento é aceito. **Por que existe:** o aparelho do encarregado é o ponto mais exposto; ele nem vê o cadastro de pessoal (CT-034) e o rascunho não pode ser a porta dos fundos.
